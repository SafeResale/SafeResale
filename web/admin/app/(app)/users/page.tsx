...
import { RefreshCw, Search, Users as UsersIcon, X } from "lucide-react";
          ...
          <>
            ...
            <Dialog open={open} onOpenChange={setOpen}>
              <DialogContent className="sm:max-w-[440px]">
                ...
                <p className="text-sm text-muted-foreground">Creates an account; the user can sign in immediately.</p>
          ...
          <Card className="rounded-2xl ring-1 ring-black/5 dark:ring-white/10 overflow-hidden">
            <CardContent className="p-0">
              <div className="overflow-x-auto">
                <Table aria-label="Users" className="min-w-[720px]">
                  <TableHeader>
                    <TableRow>
                  ...
                  <TableBody>
                    {data.items.map((u) => (
                      <TableRow key={u._id}>
                        ...
                        <TableCell>
                          <StatusBadge tone={u.verified ? "success" : "neutral"} label={u.verified ? "yes" : "no"} />
                        </TableCell>
