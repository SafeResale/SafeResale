...
CATEGORIES = [
    ...
    {"name": "Car", "slug": "car", "description": "Cars and automobiles", "icon": "car",
     "fields": ["price", "year", "brand", "model", "registration_no", "odometer", "condition", "notes"], "active": True, "sort": 7},
    {"name": "Bike", "slug": "bike", "description": "Motorcycles, scooters and bicycles", "icon": "bike",
     "fields": ["price", "year", "brand", "model", "registration_no", "odometer", "condition", "notes"], "active": True, "sort": 8},
